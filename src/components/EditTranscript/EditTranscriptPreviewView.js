...
export function EditTranscriptPreviewView(props) {
    ...
    const [nomenclatureWritten] = useState(props.nomenclatureWritten);
    ...
    function translateLineChords(lineChords) {
    ...
    function buildTranscriptStructure() {
        ...
        while (lyrics.length > currentLine) {
            ...
            if (line == "") {
                ...
                lineChords = translateLineChords(lineChords);
